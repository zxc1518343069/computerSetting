...
const normalizePurchaseAndReturnWorkflow = (database) => {
    ensureColumn(database, 'purchase_returns', 'goods_status', "TEXT NOT NULL DEFAULT 'pending_shipment'");
    ensureColumn(database, 'purchase_returns', 'shipping_fee_cents', 'INTEGER NOT NULL DEFAULT 0');
    ensureColumn(database, 'purchase_returns', 'shipping_fee_bearer', "TEXT NOT NULL DEFAULT 'self'");
    ensureColumn(database, 'purchase_returns', 'self_shipping_fee_cents', 'INTEGER NOT NULL DEFAULT 0');
    ensureColumn(database, 'purchase_returns', 'merchant_shipping_fee_cents', 'INTEGER NOT NULL DEFAULT 0');
